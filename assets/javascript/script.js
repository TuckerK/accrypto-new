...
function searchQuery(query){
  ...
  searchVar = query || $(".searchForm").val();
  var hrChange24;
  var coinAbbrev;
  ...
  $.ajax({
    ...
    $("#card-body").prepend(
      '<div class="card apiLink"><div class="card-block"><h4 data-currencyName=' +
        searchVar +
...
var queryURL = "https://newsapi.org/v2/everything?language=en&q=" + searchVar +
   ...
   .done(function(response) {
      console.log(response);
       ...
       for (var i = 1; i < 4; i++){
            ...
            '</p><a href="'+newsUrl+'" id="link-news" target="_blank">'+newsUrl+ '</a></div>');
